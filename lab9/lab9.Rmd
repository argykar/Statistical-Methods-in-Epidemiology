...
They are calculated as: $$RERI = OR_{A=1, B=1} - OR_{A=1, B=0} - OR_{A=0, B=1} + 1$$ $$SI = \frac{OR_{A=1, B=1} - 1}{OR_{A=1, B=0} + OR_{A=0, B=1} - 2}$$ $$ROR = \frac{OR_{A=1, B=1}}{OR_{A=1, B=0}*OR_{A=0, B=1}}$$
